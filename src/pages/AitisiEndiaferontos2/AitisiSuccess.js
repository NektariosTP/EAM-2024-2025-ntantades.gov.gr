...
import './AitisiSuccess.css';
import { useNavigate } from "react-router-dom";

function AitisiSuccess() {
  ...
  return (
    <div className="form-container1">
      <h2>Η αίτηση ενδιαφέροντος συνεργασίας σας έχει υποβληθεί επιτυχώς! <img src="/green_tick_nanny.jpg" alt="Checkmark Icon" className="checkmark6-icon" /> </h2>
        ...
        <div className="button-group6-nannies">
          ...
          <button type="button" className="submit-button" onClick={() => window.location.href = `${window.location.origin}/Goneis/Profil/Istoriko_Gonea/Aithseis_Endiaferontos_Se_Ekkremothta`}>
          Μετάβαση στις αιτήσεις μου
          </button>
        </div>
    </div>
  );
