...
function AitisiTemp() {
  ...
  return (
    <div className="form-container1">
      <h2>Η αίτηση ενδιαφέροντος συνεργασίας σας αποθηκεύτηκε προσωρινά! <img src="/viewfile.png" alt="View Icon" className="view-icon" /> </h2>
      ...
      <div className="submit-box-ad2">
        <p> Μπορείτε να συνεχίσετε να επεξεργάζεστε τα στοιχεία αργότερα. Όταν τα 
            ολοκληρώσετε μπορείτε να πατήσετε “Οριστική Υποβολή”, ώστε η αίτηση σας να σταλθεί στην νταντά.</p>
