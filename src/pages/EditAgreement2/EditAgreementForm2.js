...
import "./EditAgreementForm2.css";

function EditAgreementForm2() {
    ...
    return (
        <div className="container-editagreement">
            ...
            <div className="button-section-forma-editagreement">
                <button className="cancel-btn-forma-editagreement" onClick={handleEnd}>Λήξη Συνεργασίας</button>
                <button className="next-btn-forma-editagreement" onClick={handleProceed}>Επεξεργασία Συνεργασίας</button>
            </div>
        </div>
    );
}

export default EditAgreementForm2;