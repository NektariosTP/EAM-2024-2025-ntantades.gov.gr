...
import './EditAgreementForm5.css';
import { useNavigate } from "react-router-dom";

function EditAgreementForm5() {
  ...
  return (
    <div className="form-container-editagreement-complete">
      <h2>Η Ολοκλήρωση της Συνεργασίας Επιβεβαιώθηκε Επιτυχώς
      ...
      <div className="submit-box6">
        ...
        <div className="popup-button-group6">
          <a href="/epivevaiwsh_oloklhrwshs_synergasias.pdf" download className="pdf_confirm-nanny-link">
...
export default EditAgreementForm5;
