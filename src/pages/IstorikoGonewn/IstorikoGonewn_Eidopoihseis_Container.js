...
import "./IstorikoGonewn_Eidopoihseis_Container.css";

export default function IstorikoGonewn_Eidopoihseis_Container() {
  // Αρχικά μηνύματα
  const initialMessages = [
    {
      ...
      time: "12:53μμ",
      message:
        "Η Αίτηση Ενδιαφέροντος για τον/την επαγγελματία Δήμητρα Ιωάννου απορρίφθηκε.",
      isBold: true,
      isRead: false,
    },
    {
      ...
      time: "11:43πμ",
      message:
        "Το Ραντεβού Γνωριμίας με τον/την επαγγελματία Δήμητρα Ιωάννου επιβεβαιώθηκε.",
      isBold: false,
      isRead: true,
    },
    {
      ...
      time: "6:17μμ",
      message:
        "Το Ραντεβού Γνωριμίας με τον/την επαγγελματία Έλενα Ζάση επιβεβαιώθηκε.",
      isBold: false,
      isRead: true,
    },
    {
      ...
      time: "4:57μμ",
      message:
        "Η Λήξη Συνεργασίας με τον/την επαγγελματία Χρήστο Μπίκο επιβεβαιώθηκε.",
      isBold: false,
      isRead: true,
    },
    {
      ...
      time: "9:37μμ",
      message:
        "Η Λήψη του Ψηφιακού Voucher από τον/την επαγγελματία Χρήστο Μπίκο επιβεβαιώθηκε.",
      isBold: false,
      isRead: true,
    },
    {
