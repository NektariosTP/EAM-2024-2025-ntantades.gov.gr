...
import "./IstorikoGonewn_IdiwtikaSymfwnhtika_Ekkremothta_Container.css"

export default function IstorikoGonewn_IdiwtikaSymfwnhtika_Ekkremothta_Container() {
  ...
  const handleCancelContract = (index) => {
    ...
    const completedContracts = JSON.parse(localStorage.getItem("completedContracts")) || [];
    ...
    localStorage.setItem("pendingContracts", JSON.stringify(updatedContracts));
  };
            ...
            <div key={index} className="idiotika-item">
              ...
              <div className="idiotika-contentt">
                <p className="bold-text">
                  Όνομα Νταντάς: <span className="idiotika-nanny-name">{payment.name}</span>
                  </p>
              ...
              <div className="idiotika-buttons">
                <button className="edit-button" onClick={() => window.location.href = "/Goneis/Profil/Synergasies/Leptomereies_Active/Epeksergasia"}>Επεξεργασία Ιδιωτικού Συμφωνητικού</button>
