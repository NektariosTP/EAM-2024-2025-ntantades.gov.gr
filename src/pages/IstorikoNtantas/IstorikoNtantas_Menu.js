...
export default function SidebarMenu_Ntanta() {
  ...
  const menuItems = [
    {
      id: 32,
      text: "Ραντεβού με Γονείς",
      basePath: "/Ntantades/Profil/Istoriko_Ntanta",
      subItems: [
    ...
    },
    {
      ...
      basePath: "/Ntantades/Profil/Istoriko_Ntanta",
      subItems: [
        { text: "Σε εκκρεμότητα", path: "Plhrwmes_Prosexws" },
        { text: "Ολοκληρωμένες", path: "Plhrwmes_Oloklhrwmenes" },
      ],
    },
    {
      id: 36,
      text: "Αξιολογήσεις",
      basePath: "/Ntantades/Profil/Istoriko_Ntanta/Aksiologhseis",
      subItems: [],
    },
    {
      id: 37,
      text: "Ειδοποιήσεις",
      basePath: "/Ntantades/Profil/Istoriko_Ntanta/Eidopoihseis",
      subItems: [],
    },
  ];
