...
import "./NannyEditForm1.css";
import { useNavigate } from "react-router-dom";

function NannyEditForm1() {
  ...
  return (
    <form className="form-container" onSubmit={handleSubmit}>
      ...
      <label className="label-nanny-register">Έτος Γέννησης (*)</label>
      <input
        type="number"
        name="birthYear"
    ...
    <label className="label-nanny-register">Είστε γονέας; (*)</label>
      <div className="radio-group1">
        <label className="label-nanny-register">
          <input className="input-nanny"
            type="radio"
