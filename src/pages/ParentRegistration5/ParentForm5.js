    ...
    <div className="form-container">
      ...
      <div className="submit-box">
        ...
        <div className="button-group5-nannies">
          <button type="button" className="back-button" onClick={() => navigate("/Goneis/Aggelies/Profile")}>
            Ακύρωση Εγγραφής
          </button>
          <button 
          ...
          <button type="button" className="submit-button" onClick={() => navigate("/Goneis/Eggrafi/Epitixia_Eggrafis")}>
            Ολοκλήρωση Εγγραφής
          </button>
        </div>
      </div>
      ...
      <div className="button-group5-nannies-back">
        <button type="button" className="back-button" onClick={() => navigate("/Goneis/Eggrafi/4")}>
          Πίσω
        </button>
      </div>
    </div>
