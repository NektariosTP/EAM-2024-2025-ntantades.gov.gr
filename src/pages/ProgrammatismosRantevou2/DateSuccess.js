...
function DateSuccess() {
  ...
  return (
    <div className="form-container1">
      <h2>Η αίτηση για ραντεβού έχει υποβληθεί επιτυχώς! <img src="/green_tick_nanny.jpg" alt="Checkmark Icon" className="checkmark6-icon" /> </h2>

        {nanny ? (
          <div key={nanny.id} className="filtered-card-rantevou1">
        ...
        {savedAppointment && (
          <div className="appointment-details">
            ...
            <p><strong>Ημερομηνία:</strong> {savedAppointment.date}</p>
            <p><strong>Ώρα:</strong> {savedAppointment.time1}:{savedAppointment.time2}</p>
            <p><strong>Τρόπος διεξαγωγής:</strong> {savedAppointment.executionMode}</p>
            {savedAppointment.executionMode === "Δια ζώσης" && (
              <>
                {savedAppointment.location !== "Επιλέξτε διεύθυνση" && (
                  <p><strong>Διεύθυνση:</strong> {savedAppointment.location}</p>
                )}
                {savedAppointment.location === "Επιλέξτε διεύθυνση" && (
                  <p><strong>Διεύθυνση:</strong> {savedAppointment.address}</p>
                )}
              </>
            )}
          </div>
