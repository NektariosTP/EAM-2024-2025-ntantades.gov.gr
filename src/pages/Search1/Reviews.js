    ...
    const reviews = [
        {
            ...
            location: "Χαλάνδρι",
            rating: 4.2,
            feedback: "Η Κατερίνα είναι υπεύθυνη, στοργική και δημιουργική. Εμπιστευόμαστε απόλυτα τη φροντίδα της!",
        },
        {
            id: 2,
            ...
            location: "Καισαριανή",
            rating: 3.9,
            feedback: "Βρήκαμε την τέλεια νταντά μέσω της ιστοσελίδας. Η Σοφία φροντίζει το παιδί μας με αγάπη και προσοχή!",
        },
        {
            id: 3,
            name: "Ελένη Γεωργίου",
